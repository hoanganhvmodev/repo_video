    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ bgcolor: "#29303B", paddingX: "48px" }}>
        <Toolbar sx={{ px: 12 }}>
          ...
          <Box sx={{ pr: 4 }}>
            <Link href="#" underline="none" ><Image src={logo} duration={0} style={{ padding: "8px", backgroundColor: "white", borderRadius: "5px" }} /></Link>
          </Box>
          <Box sx={{ fontSize: "22px" }}>{'Learning Reactjs (PRO)' || ''}</Box>
          <Box sx={{ flexGrow: 1 }} />
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            <Box sx={{ mr: 5, fontSize: "16px", display: "flex", alignItems: "center" }}>
              {'50/100 video da xem'}
            </Box>
            <IconButton
              size="large"
            ...
            <Box sx={{ display: { xs: 'flex', alignItems: "center", color: "white" } }}>
              {'Hi, Nguyen anh' || ''}
            </Box>
