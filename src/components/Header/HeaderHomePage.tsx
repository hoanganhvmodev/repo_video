...
export default function Header() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ bgcolor: "whitesmoke", paddingX: "48px" }}>
        <Toolbar sx={{ px: 12 }}>
          <Box sx={{ pr: 12 }}>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            ...
            >
              <Badge badgeContent={17} color="error">
                <NotificationsIcon sx={{ color: "#666666", fontSize: "22px" }} />
              </Badge>
            </IconButton>
            <IconButton
            ...
            <Box sx={{ display: { xs: 'flex', alignItems: "center", color: "#3C3C3C", width: "15ch" }}}> 
              {'Hi, Nguyen anh' || ''}
            </Box>
